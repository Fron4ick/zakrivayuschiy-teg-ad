const cardsData = [
  ...
  [
    ...
    { image: './svg/car.svg', label: '&lt;desigions&gt;' }
  ],
  [
  ...
  [
    ...
    { image: './svg/car.svg', label: 'support' }
  ],
  [
    ...
    { image: './svg/car.svg', label: '&lt;lifes-style: none&gt;' }
  ],
  [
    '«Сейчас я здесь»',
    false, // status_like - начальное состояние лайка
    ...
    { image: './svg/car.svg', label: '&lt;experience&gt;' }
  ],
];
